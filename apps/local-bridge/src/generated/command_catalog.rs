...
pub const COMMAND_CATALOG: &[CommandEntry] = &[
    ...
    CommandEntry { id: "bridge.mutation.approve", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    CommandEntry { id: "bridge.mutation.refine_request", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    CommandEntry { id: "bridge.mutation.reject", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    CommandEntry { id: "coding.context.ask_about_file", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    CommandEntry { id: "coding.context.ask_about_selection", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    CommandEntry { id: "coding.context.request_edit", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    CommandEntry { id: "coding.context.request_tests", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    ...
    CommandEntry { id: "extensions.approve_promotion", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    ...
    CommandEntry { id: "extensions.list_approvals", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::ReadOnly },
    CommandEntry { id: "extensions.request_promotion", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    CommandEntry { id: "extensions.update_trust", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    CommandEntry { id: "gate.evaluate", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    CommandEntry { id: "gate.override", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    CommandEntry { id: "gate.revoke_override", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    CommandEntry { id: "gate.signoff", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    ...
    CommandEntry { id: "perf.latest_run", status: CommandStatus::Implemented, scope: CommandScope::Sessionless, side_effect: CommandSideEffect::ReadOnly },
    ...
    CommandEntry { id: "project.file.request", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::ReadOnly },
    CommandEntry { id: "project.tree.request", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::ReadOnly },
    ...
    CommandEntry { id: "release.deploy", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::External },
    CommandEntry { id: "release.generate_notes", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    CommandEntry { id: "release.list_targets", status: CommandStatus::Implemented, scope: CommandScope::Either, side_effect: CommandSideEffect::ReadOnly },
    CommandEntry { id: "release.publish", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::External },
    CommandEntry { id: "review.hunk.action.request", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    ...
    CommandEntry { id: "review.revert_file", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    ...
    CommandEntry { id: "task.execution.continue", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    CommandEntry { id: "task.plan.request_changes", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    ...
    CommandEntry { id: "validation.failure.send_context", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    CommandEntry { id: "validation.run.request", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    ...
    CommandEntry { id: "workspace.branch.request", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::ReadOnly },
    CommandEntry { id: "workspace.preview.open", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    CommandEntry { id: "workspace.preview.refresh", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    CommandEntry { id: "workspace.preview.run_e2e", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    CommandEntry { id: "workspace.preview.send_context", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
    CommandEntry { id: "workspace.preview.stop", status: CommandStatus::Implemented, scope: CommandScope::Session, side_effect: CommandSideEffect::State },
];
