...
#[rustfmt::skip]
pub const EVENT_CATALOG: [EventEntry; 133] = [
    EventEntry { id: "acp.debug_message", status: EventStatus::Implemented },
    EventEntry { id: "activity.appended", status: EventStatus::Implemented },
    EventEntry { id: "approval.pending", status: EventStatus::Implemented },
    EventEntry { id: "approval.resolved", status: EventStatus::Implemented },
    ...
    EventEntry { id: "assessment.completed", status: EventStatus::Implemented },
    EventEntry { id: "assessment.evidence_attached", status: EventStatus::Implemented },
    EventEntry { id: "assessment.failed", status: EventStatus::Implemented },
    ...
    EventEntry { id: "assessment.started", status: EventStatus::Implemented },
    ...
    EventEntry { id: "config.reload.started", status: EventStatus::Implemented },
    EventEntry { id: "config.reload_failed", status: EventStatus::Implemented },
    EventEntry { id: "config.reloaded", status: EventStatus::Implemented },
    EventEntry { id: "config.validated", status: EventStatus::Implemented },
    ...
    EventEntry { id: "notify.event", status: EventStatus::Implemented },
    ...
    EventEntry { id: "plan.updated", status: EventStatus::Implemented },
    ...
    EventEntry { id: "registry.added", status: EventStatus::Implemented },
    EventEntry { id: "registry.reloaded", status: EventStatus::Implemented },
    EventEntry { id: "registry.synced", status: EventStatus::Implemented },
    EventEntry { id: "release.audit", status: EventStatus::Implemented },
    ...
    EventEntry { id: "runtime.job_log", status: EventStatus::Implemented },
    EventEntry { id: "runtime.job_started", status: EventStatus::Implemented },
    EventEntry { id: "session.auth_failed", status: EventStatus::Implemented },
    EventEntry { id: "session.auth_requested", status: EventStatus::Implemented },
    EventEntry { id: "session.auth_updated", status: EventStatus::Implemented },
    EventEntry { id: "session.available_commands.updated", status: EventStatus::Implemented },
    EventEntry { id: "session.closed", status: EventStatus::Implemented },
    EventEntry { id: "session.config_options.updated", status: EventStatus::Implemented },
    EventEntry { id: "session.context.updated", status: EventStatus::Implemented },
    EventEntry { id: "session.history.forgotten", status: EventStatus::Implemented },
    EventEntry { id: "session.history.listed", status: EventStatus::Implemented },
    EventEntry { id: "session.list_response", status: EventStatus::Implemented },
    EventEntry { id: "session.mcp_server_drift", status: EventStatus::Implemented },
    EventEntry { id: "session.mode.updated", status: EventStatus::Implemented },
    EventEntry { id: "session.persistence_degraded", status: EventStatus::Implemented },
    EventEntry { id: "session.ready", status: EventStatus::Implemented },
    EventEntry { id: "session.renamed", status: EventStatus::Implemented },
    EventEntry { id: "session.replay.progress", status: EventStatus::Implemented },
    EventEntry { id: "session.resume.failed", status: EventStatus::Implemented },
    EventEntry { id: "session.resume.initializing", status: EventStatus::Implemented },
    EventEntry { id: "session.resume.started", status: EventStatus::Implemented },
    EventEntry { id: "session.resume.warning", status: EventStatus::Implemented },
    EventEntry { id: "session.resumed", status: EventStatus::Implemented },
    ...
    EventEntry { id: "system.capabilities", status: EventStatus::Implemented },
    EventEntry { id: "system_pulse.updated", status: EventStatus::Implemented },
    ...
    EventEntry { id: "terminal.lifecycle", status: EventStatus::Implemented },
    EventEntry { id: "tool.diff.updated", status: EventStatus::Implemented },
    EventEntry { id: "tool.failed", status: EventStatus::Implemented },
    EventEntry { id: "tool.observed", status: EventStatus::Implemented },
    EventEntry { id: "tool.terminal.updated", status: EventStatus::Implemented },
    EventEntry { id: "tool.updated", status: EventStatus::Implemented },
    EventEntry { id: "transcript.completed", status: EventStatus::Implemented },
    EventEntry { id: "transcript.delta", status: EventStatus::Implemented },
    EventEntry { id: "transcript.error", status: EventStatus::Implemented },
    EventEntry { id: "transcript.thought_delta", status: EventStatus::Implemented },
    EventEntry { id: "vac.session_resumed_native", status: EventStatus::Implemented },
