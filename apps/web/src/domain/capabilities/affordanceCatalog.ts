...
const SPECS: ReadonlyArray<AffordanceSpec> = Object.freeze([
	...
	},
	{
		...
		component: 'Approvals.ApproveButton',
		command: 'approval.approve',
		when: { hasTransport: true },
		enabledIf: { commandStatus: 'implemented' },
		disabledCopy: 'Connect to the bridge to approve this request.',
	},
	{
		id: 'approvals.reject',
		component: 'Approvals.RejectButton',
		command: 'approval.reject',
		when: { hasTransport: true },
		enabledIf: { commandStatus: 'implemented' },
		disabledCopy: 'Connect to the bridge to reject this request.',
	},
	{
